...
let rec rem_anchovy = x =>
  ...
  | @implicit_arity Topping(Tuna, p) => @implicit_arity Topping(Tuna, rem_anchovy(p))
  | @implicit_arity Topping(Lox, p) => @implicit_arity Topping(Lox, rem_anchovy(p))
  }
...
let rec rem_anchovy = x =>
  ...
  | Bottom => Bottom
  | @implicit_arity Topping(Anchovy, p) => rem_anchovy(p)
  | @implicit_arity Topping(t, p) => @implicit_arity Topping(t, rem_anchovy(p))
  }
...
let rec rem_tuna = x =>
  switch x {
  | Bottom => Bottom
  | @implicit_arity Topping(Anchovy, p) => @implicit_arity Topping(Anchovy, rem_tuna(p))
  | @implicit_arity Topping(Tuna, p) => rem_tuna(p)
  | @implicit_arity Topping(Lox, p) => @implicit_arity Topping(Lox, rem_tuna(p))
  }
...
let rec rem_tuna = x =>
  ...
  | Bottom => Bottom
  | @implicit_arity Topping(Tuna, p) => rem_tuna(p)
  | @implicit_arity Topping(t, p) => @implicit_arity Topping(t, rem_tuna(p))
  }
